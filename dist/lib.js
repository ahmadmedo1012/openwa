 ...
 */
export function advanceDeliveryStatus(current, next) {
 ...
 */
export function beginSessionStart(rs, start) {
 ...
 */
export function resetSessionIdentity(rs) {
 ...
 */
export function applyConnectionClose(rs, close, fx) {
